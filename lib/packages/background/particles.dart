...
class ParticleOptions {
  ...
  const ParticleOptions({
    ...
    this.spawnMaxRadius = 30.0,
    this.spawnMinSpeed = 60.0,
    this.spawnMaxSpeed = 120.0,
...
class Particle {
  ...
  /// implementation is as follows: The [ParticleBehaviour] needs to the
...
abstract class ParticleBehaviour extends Behaviour {
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    for (Particle particle in particles!) {
      ...
      _paint!.color = options.baseColor.withValues(alpha: particle.alpha);
...
class RandomParticleBehaviour extends ParticleBehaviour {
  ...
  RandomParticleBehaviour({super.options, super.paint});
