...
class SpaceBehaviour extends Behaviour {
  ...
  SpaceBehaviour({Color backgroundColor = const Color(0xFF000000)}) {
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    for (Star star in stars!) {
      ...
      paint.strokeWidth = z;
      canvas.drawLine(Offset(x, y), star.position!, paint);
      i++;
    }
    canvas.translate(-center!.dx, -center!.dy);
  }
    ...
    return Opacity(
      ...
      child: Transform(
        transform: Matrix4.identity()
          ..setEntry(3, 2, 1.0)
          ..translateByDouble(widgetX, widgetY, _childZ, 1.0),
        child: super.builder(context, constraints, child),
      ),
    );
  }
